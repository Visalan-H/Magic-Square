let yy, mm, dd, y1, y2;
let mntext=document.getElementById("magicnumber");
let magicnumm=document.getElementById("mn");
let i2=document.getElementById("inst2");
...
function magic_square() {
    ...
    magicnumm.innerText=Number(dd)+Number(mm)+Number(y1)+Number(y2);
